...
#include "DataWrapper/LasaDataStreamWrapper.h"
...
#define HAND_IN_PORT        "/DataWrapperHand/in"
...
void FillHandDataForMsg(DataWrapper::LasaDataStreamWrapper& msg)
{
    int sum;
    //<hyin/Sep-25-2013>
...
int main(int argc, char** argv)
{
    ...
    ros::Rate rate(100);
    publisher = hNode.advertise< DataWrapper::LasaDataStreamWrapper >( WRAP_TOPIC, 5 );
    ...
    {
        ros::spinOnce();
        DataWrapper::LasaDataStreamWrapper msg;
