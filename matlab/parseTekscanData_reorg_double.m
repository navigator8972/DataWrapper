function fingers = parseTekscanData_reorg_double(data)
    thumb1 = [];
    thumb2 = [];
    index1 = [];
    index2 = [];
    ...
    fingers{4,1,1} = pinky3;    
    fingers{4,2,1} = pinky2;
    fingers{4,3,1} = pinky1;    
    fingers{4,1,2} = Smiddle3;
    fingers{4,2,2} = Smiddle2;
    fingers{4,3,2} = Smiddle1;    

    fingers{5,1,1} = Sring3;
    fingers{5,2,1} = Sring2;
    fingers{5,3,1} = Sring1;        
